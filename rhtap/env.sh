...
export IMAGE_URL=${IMAGE_URL-quay.io/chetna14manku_org/dotnet-basic-cxzfjzic:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/chetna14manku-org/dotnet-basic-cxzfjzic-gitops
